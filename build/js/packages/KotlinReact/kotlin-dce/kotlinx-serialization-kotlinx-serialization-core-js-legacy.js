(function (root, factory) {
  ...
  ListLikeSerializer.prototype.serialize_55azsf$ = function (encoder, value) {
    ...
    for (var index = 0; index < size; index++)
      composite.encodeSerializableElement_r4qlx7$(this.descriptor, index, this.elementSerializer_0, iterator.next());
  ...
  function UIntSerializer() {
    ...
    this.descriptor_twumwr$_0 = InlinePrimitiveDescriptor('kotlin.UInt', serializer_2(kotlin_js_internal_IntCompanionObject));
  }
  ...
  UIntSerializer.prototype.serialize_55azsf$ = function (encoder, value) {
    var tmp$;
    if ((tmp$ = encoder.encodeInline_24f42q$(this.descriptor)) != null) {
      tmp$.encodeInt_za3lpa$(value.data);
    }};
  ...
  function ULongSerializer() {
    ...
    this.descriptor_3i3rs4$_0 = InlinePrimitiveDescriptor('kotlin.ULong', serializer_3(kotlin_js_internal_LongCompanionObject));
  }
  ...
  ULongSerializer.prototype.serialize_55azsf$ = function (encoder, value) {
    var tmp$;
    if ((tmp$ = encoder.encodeInline_24f42q$(this.descriptor)) != null) {
      tmp$.encodeLong_s8cxhz$(value.data);
    }};
  ...
  function UByteSerializer() {
    ...
    this.descriptor_x7d240$_0 = InlinePrimitiveDescriptor('kotlin.UByte', serializer_0(kotlin_js_internal_ByteCompanionObject));
  }
  ...
  UByteSerializer.prototype.serialize_55azsf$ = function (encoder, value) {
    var tmp$;
    if ((tmp$ = encoder.encodeInline_24f42q$(this.descriptor)) != null) {
      tmp$.encodeByte_s8j3t7$(value.data);
    }};
  ...
  function UShortSerializer() {
    ...
    this.descriptor_q9gay6$_0 = InlinePrimitiveDescriptor('kotlin.UShort', serializer_1(kotlin_js_internal_ShortCompanionObject));
  }
  ...
  UShortSerializer.prototype.serialize_55azsf$ = function (encoder, value) {
    var tmp$;
    if ((tmp$ = encoder.encodeInline_24f42q$(this.descriptor)) != null) {
      tmp$.encodeShort_mq22fl$(value.data);
    }};
  ...
  function PluginGeneratedSerialDescriptor(serialName, generatedSerializer, elementsCount) {
    ...
    this.childSerializers_am32qy$_0 = lazy(PluginGeneratedSerialDescriptor$childSerializers$lambda(this));
    this.typeParameterDescriptors_8be2vx$_tf62pe$_0 = lazy(PluginGeneratedSerialDescriptor$typeParameterDescriptors$lambda(this));
  ...
  function PluginGeneratedSerialDescriptor$childSerializers$lambda(this$PluginGeneratedSerialDescriptor) {
    return function () {
      var tmp$, tmp$_0;
      return (tmp$_0 = (tmp$ = this$PluginGeneratedSerialDescriptor.generatedSerializer_0) != null ? tmp$.childSerializers() : null) != null ? tmp$_0 : [];
    };
  }
  ...
  function serializer_15(type) {
    return serializer_16(EmptySerializersModule, type);
  }
  function serializer_16($receiver, type) {
    var tmp$;
  ...
  function builtinSerializer($receiver, typeArguments, rootClass, failOnMissingTypeArgSerializer) {
    ...
    if (failOnMissingTypeArgSerializer) {
      var transform = getCallableRef('serializer', function ($receiver, p1) {
        return serializer_16($receiver, p1);
      }.bind(null, $receiver));
  ...
  package$builtins.serializer_wxu9yi$ = serializer_9;
  package$builtins.serializer_de2ylp$ = serializer_10;
  package$builtins.serializer_28ajz5$ = serializer_11;
  package$builtins.serializer_wdte4j$ = serializer_12;
  ...
  package$serialization.serializer_saj79j$ = serializer_15;
  package$serialization.serializer_ca95z9$ = serializer_16;
