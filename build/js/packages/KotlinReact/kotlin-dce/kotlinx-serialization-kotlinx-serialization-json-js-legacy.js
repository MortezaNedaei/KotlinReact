(function (root, factory) {
  ...
  Object.defineProperty(Composer.prototype, 'writingFirst', {configurable: true, get: function () {
  ...
  Composer.$metadata$ = {kind: Kind_CLASS, simpleName: 'Composer', interfaces: []};
  ...
  ComposerForUnsignedNumbers.$metadata$ = {kind: Kind_CLASS, simpleName: 'ComposerForUnsignedNumbers', interfaces: [Composer]};
  ...
  JsonLexer.$metadata$ = {kind: Kind_CLASS, simpleName: 'JsonLexer', interfaces: []};
